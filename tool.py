...
regex_patterns = {
    '🇭🇰': re.compile(r'香港|沪港|呼港|中港|HKT|HKBN|HGC|WTT|CMI|穗港|京港|HK|hk|Hongkong|Hong Kong|HongKong|HONG KONG'),
    '🇹🇼': re.compile(r'台湾|台灣|臺灣|台北|台中|新北|彰化|台|CHT|HINET|TW|tw|Taiwan|TAIWAN'),
    '🇲🇴': re.compile(r'澳门|澳門|(\s|-)?MO\d*|CTM|MAC|Macao|Macau'),
    '🇸🇬': re.compile(r'新加坡|狮城|獅城|沪新|京新|泉新|穗新|深新|杭新|广新|廣新|滬新|SG|sg|Singapore|SINGAPORE'),
    '🇯🇵': re.compile(r'日本|东京|大阪|埼玉|京日|苏日|沪日|上日|穗日|川日|中日|泉日|杭日|深日|JP|jp|Japan|JAPAN'),
    '🇺🇸': re.compile(r'美国|美國|京美|硅谷|凤凰城|洛杉矶|西雅图|圣何塞|芝加哥|哥伦布|纽约|(\s|-)?(?<![AR])US\d*|USA|us|America|United States'),
    '🇰🇷': re.compile(r'韩国|韓國|首尔|韩|韓|春川|KOR|KR|kr|Kr|(?<!North\s)Korea'),
